...
description: Record, clean up, and structure learning experiments across the LLM_Learn notes workspace and the dev1 remote machine. Use when the user wants to log a robotics, MuJoCo, LeRobot, CV, LLM, or AI Infra experiment, turn shell output or trial-and-error into a proper note, summarize what was tried, record environment facts, capture benchmark results, or make experiment notes reproducible.
---

# Learning Experiment Logbook
...
- benchmark output
- MuJoCo / LeRobot / OpenCV / robotics simulation observations
- model loading / CUDA / torch / inference-runtime observations when relevant
...
2. Relevant project note in `LLM_Learn/03_Projects/`
...
- Tie the experiment back to the current learning line and the relevant Pillar in `00_Roadmap/02_Capability_Map.md`
