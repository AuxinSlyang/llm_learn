...
这里用于保留仍与长期目标强相关的“专题 / 项目化学习对象”。

项目层回答的问题是：哪些主题值得持续推进、反复回看、沉淀代码 / 笔记 / 总结，而不是只放在某一天的 Daily 里。
...
后续只有满足下面条件的内容才建议进入 `03_Projects/`：

- 与机器人系统、具身智能、AI Infra、LLM 基础或它们之间的连接长期相关
- 具有项目化或专题化推进价值
- 不适合只放在 Daily / Weekly / Monthly 中
- 可以形成持续的笔记、实验、代码、总结闭环
